...
class TestSources(unittest.TestCase):
    ...
    def test_s3_fallback_nocreds(self, mock_client_factory):
        ...
        success, img = self.sources.load_from_s3_url("s3://bucket/image.jpg", self.validator)
    ...
    def test_s3_fallback_403(self, mock_client_factory):
        ...
        error_response = {'Error': {'Code': '403'}, 'ResponseMetadata': {'HTTPStatusCode': 403}}
        mock_client.get_object.side_effect = [
    ...
    def test_gs_fallback_nocreds(self, mock_client_factory):
        ...
        mock_blob = MagicMock()
        mock_blob.download_as_bytes.side_effect = DefaultCredentialsError("no creds")
        ...
        success, img = self.sources.load_from_gs_url("gs://bucket/image.jpg", self.validator)
...
class TestSourcesCaching(unittest.TestCase):
    ...
    def test_s3_client_caching(self, mock_client_factory):
        ...
        mock_client = MagicMock()
        mock_client_factory.return_value = mock_client
        mock_client.get_object.return_value = {'Body': MagicMock(read=lambda: b'mock_data')}
