...
key_pairs = { 
        ...
        "WzEsNywid29ya2Zsb3ctbG9hZGVkLWZvMWphdTN0LjAiLCJhZG1pbiIsIjEyMzRCVFFMUF8lMnR0Il0=":
            [1,7,"workflow-loaded-fo1jau3t.farm0000.cloud.aperturedata.io","admin","1234BTQLP_%2tt"],
        "WzEsNSwidGVzdC0zcWpxdDZrcy40IiwiWVFadVZVV2Zab0FkWjJrUUVMeFB5RnptZHJ3WXd0cjBBRGEiXQ==":
            [1,5,"test-3qjqt6ks.farm0004.cloud.aperturedata.io", "YQZuVUWfZoAdZ2kQELxPyFzmdrwYwtr0ADa"],
        ...
        [1,4,"tcp-557epnn3.farm0909.cloud.aperturedata.io:1918","admin","890EpMn+!%2$_"],
        "WzEsNiwiaHR0cC05MGpnM3pwcy4xMjo0NDMiLCJZUVp1VlVXZlpvQWRaMmtRRUx4UHlGem1kcndZd3RyMEFEYSJd":
        [1,6,"http-90jg3zps.farm0012.cloud.aperturedata.io:443","YQZuVUWfZoAdZ2kQELxPyFzmdrwYwtr0ADa"]
        }
    ...
    def test_encode_keys(self):
        for key,data in key_pairs.items():
            ...
            if len(data) == 4:
                ...
                username = data[3]
                password = data[4]
            c = Configuration(host,port,username,password,"encoding test",use_rest=rest,use_ssl=ssl,token=token)
            deflated = c.deflate()
            assert deflated == key 
